class AudioFile < ActiveRecord::Base
  ...
  attr_accessible :audio_length, :audio_start, :bitrate, :boolean, :file_modified_time, :file_size, :filename, :layer, :length, :mime_type, :mpeg_version, :references, :samplerate, :song, :tracknum, :vbr
  attr_accessible :file_dir, :artist, :album, :song, :genre
